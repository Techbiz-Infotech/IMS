report 50145 "Loose Cargo Received"
{
    ApplicationArea = All;
    Caption = 'Loose  Cargo Received';
    ...
    dataset
    {
        dataitem("Manifest Line"; "Manifest Line")
        {
            ...
            begin
                SETFILTER("Date Received", '%1..%2', StartDate, EndDate);
            end;
    ...
    begin
        ...
        TempExcelBuffer.AddColumn('Loose Cargo Received', FALSE, '', TRUE, FALSE, TRUE, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.NewRow();
    ...
    begin
        TempExcelBuffer.CreateNewBook('Loose Cargo Received Report');
        TempExcelBuffer.WriteSheet('Loose Cargo Received Report', CompanyName, UserId);
        TempExcelBuffer.CloseBook();
        TempExcelBuffer.SetFriendlyFilename('Loose Cargo Received Report');
