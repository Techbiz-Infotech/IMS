table 50126 "Containers Cue"
{
    ...
    fields
    {
        ...
        field(19; "EMPTYCTR Rcvd Containers Today"; Integer)
        {
            Caption = 'Received Containers Today';
            FieldClass = FlowField;
            CalcFormula = count("Manifest Line" where(Received = filter(true), "Date Received" = Field("Current Date Filter"), "Shortcut Dimension 4 Code" = filter('CONTAINER'), "Shortcut Dimension 6 Code" = filter('EMPTY CONTAINER')));
        }
        field(20; "EMPTYCTR Reld Containers Today"; Integer)
        {
            Caption = 'Released Containers Today';
            FieldClass = FlowField;
            CalcFormula = count("Manifest Line" where(Released = filter(true), "Date Released" = Field("Current Date Filter"), "Shortcut Dimension 4 Code" = filter('CONTAINER'), "Shortcut Dimension 6 Code" = filter('EMPTY CONTAINER')));
        }
        field(21; "EMPTYCTR Stock 40FT"; Integer)
        {
            Caption = 'Stock 40FT';
            FieldClass = FlowField;
            CalcFormula = count("Manifest Line" where(Received = filter(true), Released = filter(false), "Shortcut Dimension 5 Code" = filter('40FT'), "Shortcut Dimension 6 Code" = filter('EMPTY CONTAINER')));
        }
        field(22; "EMPTYCTR Stock 20FT"; Integer)
        {
            Caption = 'Stock 20FT';
            FieldClass = FlowField;
            CalcFormula = count("Manifest Line" where(Received = filter(true), Released = filter(false), "Shortcut Dimension 5 Code" = filter('20FT'), "Shortcut Dimension 6 Code" = filter('EMPTY CONTAINER')));
        }
        field(23; "EMPTYCTR Container Stock"; Integer)
        {
            Caption = 'Container Stock';
            FieldClass = FlowField;
            CalcFormula = count("Manifest Line" where(Received = filter(true), Released = filter(false), "Shortcut Dimension 5 Code" = filter('20FT|40FT'), "Shortcut Dimension 6 Code" = filter('EMPTY CONTAINER')));
        }
